...
new Vue({
    ...
    methods: {
        getAndShowAllBookings: function () {
            var _this = this;
        ...
        addBooking: function () {
            ...
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, this.inputData)
                .then(function (response) {
                _this.addMessage = "Booking added";
                _this.getAndShowAllBookings();
            })
                .catch(function (error) {
                alert(error.message);
            });
